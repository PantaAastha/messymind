-- Migration to insert Ambient Shopping pattern
-- This pattern covers both "Impulse Browsing" and "Ambient Shopping" behaviors
-- It's a comprehensive definition for pre-intent warming shoppers

-- Insert or update Ambient Shopping pattern
...
VALUES (
    'ambient_shopping',
    'Impulse Browsing / Ambient Shopping',
    'Pre-Intent Warming',
    'Shoppers browse for inspiration, entertainment, or light intent ("just looking") rather than to buy now. They show meaningful engagement (scrolling, reading content, returning later) but minimal checkout intent. The goal is to warm, capture intent, and create re-entry paths instead of forcing immediate conversion.',
    -- inputs_schema
    '{
        "essential": [
            {
    ...
    '[
        {
            ...
            "implementation_examples": [
                ...
                "\"Heart\" or wishlist features for items they are warming to"
            ]
        },
        {
